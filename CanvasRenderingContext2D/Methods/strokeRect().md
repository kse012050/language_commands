...
Canvas 2D API의 __``CanvasRenderingContext2D.strokeRect()``__ 메서드는 현재 [``strokeStyle``](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/strokeStyle) 및 기타 컨텍스트 설정에 따라 스트로크(윤곽선) 된 사각형을 그립니다.  
