...
initApp();
~~~
위 코드는 해당 서비스가 [싱클 페이지 애플리케이션](https://joshua1988.github.io/webpack-guide/concepts/entry.html)이라고 가정하고 작성한 코드입니다. 사용자의 __로그인 화면__ , 로그인 후 진입하는 __메인 화면__ , 그리고 __게시글을 작성하는 화면__ 등 웹 서비스에 필요한 화면들이 모두 ``index.js`` 파일에서 불러져 사용되고 있기 때문에 웹팩을 실행하면 해당 파일들의 내용까지 해석하여 파일을 빌드해줄 것입니다.

![Entry 이미지](webpack-entry.png)
...
[내용출처 웹팩 핸드북 Entry](https://joshua1988.github.io/webpack-guide/concepts/entry.html#entry)