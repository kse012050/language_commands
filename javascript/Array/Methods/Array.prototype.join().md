...
> 요소가 __undefined__ 또는 __null__ 이면 빈 문자열로 변환합니다.
...
[내용출처 MDN join() 배열을 합친다](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/join)