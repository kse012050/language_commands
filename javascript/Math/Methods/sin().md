# Math.sin()
__``Math.sin()``__ 함수는 숫자의 사인값을 반환합니다.
...
[내용출처 MDN Math.sin()](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Math/sin)