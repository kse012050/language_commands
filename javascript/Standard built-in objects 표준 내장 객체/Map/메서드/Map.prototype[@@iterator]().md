# Map.prototype[@@iterator]() ( iterator : 반복자 )
...
[내용출처 MDN 반복 기존에 쓰던 map이랑 다른 건가](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Map/@@iterator)