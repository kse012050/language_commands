...
> __경고__: 주의: 스스로를 결정하는 thenable 에서 Promise.resolve 를 호출하면 안됩니다. 이는 무한히 중첩된 프로미스를 펼치려고하므로 무한 재귀를 유발할 것입니다.
...
### 반환 값
주어진 값으로 이행된 ``Promise`` 또는 값이 promise 객체인 경우, 값으로 전달된 promise.
